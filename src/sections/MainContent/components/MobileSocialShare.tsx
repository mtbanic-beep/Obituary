export const MobileSocialShare = () => {
  return (
    <div className="lg:hidden bg-white py-8">
      <div className="max-w-[1370px] w-full mx-auto px-[15px]">
        <p className="text-[#3d3d3d] text-[15px] font-semibold leading-[15px] text-center mb-6 font-source_sans_pro">
          Share Obituary:
        </p>
        <div className="flex justify-center gap-3.5">
          <button 
            onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(window.location.href)}`, '_blank')}
            className="w-[50px] h-[50px] bg-[#4267B2] rounded-full overflow-hidden border-2 border-[#6b6b6b] hover:scale-110 transition-transform flex items-center justify-center"
          >
          ...
          <button 
            ...
            className="w-[50px] h-[50px] bg-white rounded-full flex items-center justify-center border-2 border-[#6b6b6b] hover:scale-110 transition-transform p-2"
          >
          ...
          <button 
            ...
            className="w-[50px] h-[50px] bg-white rounded-full flex items-center justify-center border-2 border-[#6b6b6b] hover:scale-110 transition-transform"
          >
