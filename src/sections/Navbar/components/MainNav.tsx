...
export const MainNav = () => {
  ...
  return (
    <header
      className={`py-3 lg:py-5 px-4 lg:px-8 relative z-50 transition-all duration-300 ${
        mobileMenuOpen
          ? "bg-[#5d6142]"
          : isScrolled
          ? "bg-[#5d6142] shadow-lg"
    ...
    >
      ...
      {/* MOBILE MENU — cannot block clicks when closed */}
      <div className={mobileMenuOpen ? "relative z-40" : "pointer-events-none"}>
        <MobileMenu
